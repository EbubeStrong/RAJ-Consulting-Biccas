...
function Header() {
    ...
    return (
        <header className="w-full overflow-hidden py-5 bg-[linear-gradient(to_right,#DBEFEB_0%,#DBEFEB_25%,#F2F1EF_45%,#F2F1EF_55%,#F2F1EF_75%,#DBEFEB_85%,#DBEFEB_90%,#DBEFEB_100%)]
">
            <Container className="hidden md:block">
                <div className="w-full flex justify-between items-center mx-auto px-0 overflow-hidden">
                    ...
                    <div className="w-full md:w-1/3">
                        <Link href="/">
                            <h1 className="text-[#54BD95] font-inter font-semibold text-[50px]"
                                data-aos="fade-right"
                                data-aos-delay="100"
                            >Biccas</h1>
                        </Link>
