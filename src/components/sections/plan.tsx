...
const PricingSection = () => {
    ...
    return (
        <section className="bg-[linear-gradient(to_right,#FFFFFF_45%,#FFFFFF_55%,#DBEFEB_85%,#DBEFEB_95%,#DBEFEB_100%)] pb-20">
            <Container>
...
function PlanSection() {
    return (
        <>
            <section className="overflow-hidden bg-[linear-gradient(to_right,#FFFFFF_45%,#FFFFFF_55%,#DBEFEB_85%,#DBEFEB_95%,#DBEFEB_100%)]">
