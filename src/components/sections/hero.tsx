                ...
                <Container>
                    <div className="w-full mx-auto flex items-start justify-between py-10 gap-7 min-[1061px]:flex-row max-[1061px]:flex-col max-[1061px]:gap-9">
                        ...
                        <div className="w-full md:w-full min-[1061px]:w-1/2">
                            <h1 className="text-[#191A15] font-inter min-[1061px]:text-[70px] md:text-[60px] text-[50px] font-bold leading-20 text-center"
                                data-aos="fade-right"
                                data-aos-delay="300"
                            >We&apos;re here to Increase your Productivity</h1>
                            ...
                            <p className="text-[#000000] min-[1061px]:text-left text-center font-medium text-[18px]"
                                data-aos="fade-right"
                                data-aos-delay="400"
                            >Let&apos;s make your work more organize and easily using the Taskio Dashboard with many of the latest features in managing work every day.</p>
                        ...
                        <div className="hidden md:block w-full mx-auto max-w-[501px]  min-[1061px]:max-w-[701px] h-[458px]">
                            <div className="relative h-full w-full lg:max-w-[450px] mx-auto">
                                ...
                                <div className="absolute top-7 bg-white shadow flex items-center justify-between mb-4 p-4 py-6 px-5 rounded-lg w-[260px] h-[65px] -left-35 gap-4" data-aos="flip-left"
                                    data-aos-delay="400">
                                    <div>
